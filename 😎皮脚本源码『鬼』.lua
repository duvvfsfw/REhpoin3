...
local Window = OrionLib:MakeWindow({Name = "REhpoin", HidePremium = false, SaveConfig = true,IntroText = "REhpoin", ConfigFolder = "REhpoin"})

game:GetService("StarterGui"):SetCore("SendNotification",{ Title = "REhpoin"; Text ="欢迎使用REhpoin脚本"; Duration = 4; })
...
about:AddParagraph("作者: 回响")
about:AddParagraph("作者qq: 3240325167")
about:AddParagraph("qq群: 364494103")
